...
import org.springframework.stereotype.Component;   //ctrl + alt + o for removing unused imports
...
@GetMapping("/") //right click ---> it has @RequestMapping(method = RequestMethod.GET) inside of it
